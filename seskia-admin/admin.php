...
<?php else: ?>
  ...
  <main class="shell main">
    ...
    <section class="hero">
      ...
      <div class="badges"><span class="badge">بله: بدون تغییر</span><span class="badge">APK: بکاپ و rollback</span><span class="badge">توکن: خارج از GitHub</span><span class="badge">لینک ثابت: /est/download</span></div>
      <?php if ($status): ?>
      <div class="stats">
